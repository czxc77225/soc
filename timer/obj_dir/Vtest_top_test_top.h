...
VL_MODULE(Vtest_top_test_top) {
  public:
    ...
    CData/*0:0*/ __PVT__timer0__DOT__carry;
    CData/*2:0*/ __PVT__console0__DOT__sim_finish;
    IData/*31:0*/ __PVT__timer0__DOT__msip_mem;
    IData/*31:0*/ __PVT__console0__DOT__log_fd;
    QData/*63:0*/ __PVT__timer0__DOT__mtimecmp;
    ...
    IData/*31:0*/ __PVT__timer0__DOT__mtime_mem[2];
    IData/*31:0*/ __PVT__timer0__DOT__mtimecmp_mem[2];
