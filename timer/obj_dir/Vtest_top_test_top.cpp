...
VL_INLINE_OPT void Vtest_top_test_top::_settle__TOP__test_top__3(Vtest_top__Syms* __restrict vlSymsp) {
    ...
    vlSymsp->TOP__test_top.__PVT__device_rdata[0U] 
        = (vlSymsp->TOP__test_top.__PVT__device_req
           [0U] ? ((0U == (0xffffU & vlSymsp->TOP__test_top.__PVT__device_addr
                           [0U])) ? vlSymsp->TOP__test_top.__PVT__timer0__DOT__msip_mem
                    : ((0x4000U == (0xffffU & vlSymsp->TOP__test_top.__PVT__device_addr
                                    [0U])) ? vlSymsp->TOP__test_top.__PVT__timer0__DOT__mtimecmp_mem
                       [0U] : ((0x4004U == (0xffffU 
                                            & vlSymsp->TOP__test_top.__PVT__device_addr
                                            [0U])) ? 
                               ...
                               [1U] : ((0xbff8U == 
                                        (0xffffU & 
                                         vlSymsp->TOP__test_top.__PVT__device_addr
                                         [0U])) ? vlSymsp->TOP__test_top.__PVT__timer0__DOT__mtime_mem
                                       [0U] : ((0xbffcU 
                                                == 
                                                (0xffffU 
                                                 & vlSymsp->TOP__test_top.__PVT__device_addr
...
VL_INLINE_OPT void Vtest_top_test_top::_sequent__TOP__test_top__5(Vtest_top__Syms* __restrict vlSymsp) {
    ...
    Vtest_top* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    CData/*0:0*/ __Vdlyvset__timer0__DOT__mtime_mem__v0;
    CData/*0:0*/ __Vdlyvset__timer0__DOT__mtime_mem__v2;
    CData/*0:0*/ __Vdlyvset__timer0__DOT__mtimecmp_mem__v0;
    CData/*0:0*/ __Vdlyvset__timer0__DOT__mtimecmp_mem__v2;
    CData/*0:0*/ __Vdlyvset__timer0__DOT__mtimecmp_mem__v3;
    CData/*2:0*/ __Vdly__console0__DOT__sim_finish;
    IData/*31:0*/ __Vdlyvval__timer0__DOT__mtime_mem__v2;
    IData/*31:0*/ __Vdlyvval__timer0__DOT__mtime_mem__v3;
    IData/*31:0*/ __Vdlyvval__timer0__DOT__mtimecmp_mem__v2;
    IData/*31:0*/ __Vdlyvval__timer0__DOT__mtimecmp_mem__v3;
    // Body
    __Vdlyvset__timer0__DOT__mtime_mem__v0 = 0U;
    __Vdlyvset__timer0__DOT__mtime_mem__v2 = 0U;
    __Vdly__console0__DOT__sim_finish = vlSymsp->TOP__test_top.__PVT__console0__DOT__sim_finish;
    __Vdlyvset__timer0__DOT__mtimecmp_mem__v0 = 0U;
    __Vdlyvset__timer0__DOT__mtimecmp_mem__v2 = 0U;
    __Vdlyvset__timer0__DOT__mtimecmp_mem__v3 = 0U;
    if (vlTOPp->rst_i) {
        __Vdlyvset__timer0__DOT__mtime_mem__v0 = 1U;
    } else {
        if ((1U & (~ vlSymsp->TOP__test_top.__PVT__device_we
                   [0U]))) {
            __Vdlyvval__timer0__DOT__mtime_mem__v2 
                = ((IData)(1U) + vlSymsp->TOP__test_top.__PVT__timer0__DOT__mtime_mem
                   [0U]);
            __Vdlyvset__timer0__DOT__mtime_mem__v2 = 1U;
            __Vdlyvval__timer0__DOT__mtime_mem__v3 
                = (vlSymsp->TOP__test_top.__PVT__timer0__DOT__mtime_mem
                   [1U] + (IData)(vlSymsp->TOP__test_top.__PVT__timer0__DOT__carry));
        }
    }
    if (vlTOPp->rst_i) {
        vlSymsp->TOP__test_top.__PVT__timer0__DOT__msip_mem = 0U;
    } else {
    ...
    if (vlTOPp->rst_i) {
        __Vdlyvset__timer0__DOT__mtimecmp_mem__v0 = 1U;
    } else {
        if (vlSymsp->TOP__test_top.__PVT__device_we
            [0U]) {
            if ((0U != (0xffffU & vlSymsp->TOP__test_top.__PVT__device_addr
                ...
                if ((0x4000U == (0xffffU & vlSymsp->TOP__test_top.__PVT__device_addr
                                 [0U]))) {
                    __Vdlyvval__timer0__DOT__mtimecmp_mem__v2 
                        = vlSymsp->TOP__test_top.__PVT__device_wdata
                        [0U];
                    __Vdlyvset__timer0__DOT__mtimecmp_mem__v2 = 1U;
                } else {
                    if ((0x4004U == (0xffffU & vlSymsp->TOP__test_top.__PVT__device_addr
                                     [0U]))) {
                        __Vdlyvval__timer0__DOT__mtimecmp_mem__v3 
                            = vlSymsp->TOP__test_top.__PVT__device_wdata
                            [0U];
                        __Vdlyvset__timer0__DOT__mtimecmp_mem__v3 = 1U;
                    }
                }
            }
        }
    }
    if (__Vdlyvset__timer0__DOT__mtime_mem__v0) {
        vlSymsp->TOP__test_top.__PVT__timer0__DOT__mtime_mem[0U] = 0U;
        vlSymsp->TOP__test_top.__PVT__timer0__DOT__mtime_mem[1U] = 0U;
    }
    if (__Vdlyvset__timer0__DOT__mtime_mem__v2) {
        vlSymsp->TOP__test_top.__PVT__timer0__DOT__mtime_mem[0U] 
            = __Vdlyvval__timer0__DOT__mtime_mem__v2;
        vlSymsp->TOP__test_top.__PVT__timer0__DOT__mtime_mem[1U] 
            = __Vdlyvval__timer0__DOT__mtime_mem__v3;
    }
    vlSymsp->TOP__test_top.__PVT__console0__DOT__sim_finish 
        = __Vdly__console0__DOT__sim_finish;
    if (__Vdlyvset__timer0__DOT__mtimecmp_mem__v0) {
        vlSymsp->TOP__test_top.__PVT__timer0__DOT__mtimecmp_mem[0U] = 0U;
        vlSymsp->TOP__test_top.__PVT__timer0__DOT__mtimecmp_mem[1U] = 0U;
    }
    if (__Vdlyvset__timer0__DOT__mtimecmp_mem__v2) {
        vlSymsp->TOP__test_top.__PVT__timer0__DOT__mtimecmp_mem[0U] 
            = __Vdlyvval__timer0__DOT__mtimecmp_mem__v2;
    }
    if (__Vdlyvset__timer0__DOT__mtimecmp_mem__v3) {
        vlSymsp->TOP__test_top.__PVT__timer0__DOT__mtimecmp_mem[1U] 
            = __Vdlyvval__timer0__DOT__mtimecmp_mem__v3;
    }
