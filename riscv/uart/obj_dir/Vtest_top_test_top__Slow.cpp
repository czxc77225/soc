...
void Vtest_top_test_top::_settle__TOP__test_top__2(Vtest_top__Syms* __restrict vlSymsp) {
    ...
    vlSymsp->TOP__test_top.__PVT__cfg_device_addr_base[3U] = 0x300000U;
    vlSymsp->TOP__test_top.__PVT__cfg_device_addr_mask[3U] = 0xffff0000U;
    vlSymsp->TOP__test_top.__PVT__cfg_device_addr_base[4U] = 0x310000U;
    vlSymsp->TOP__test_top.__PVT__cfg_device_addr_mask[4U] = 0xffff0000U;
    ...
    vlSymsp->TOP__test_top.__Vcellinp__u_bus__cfg_device_addr_base[3U] 
        = vlSymsp->TOP__test_top.__PVT__cfg_device_addr_base
        [3U];
    vlSymsp->TOP__test_top.__Vcellinp__u_bus__cfg_device_addr_base[4U] 
        = vlSymsp->TOP__test_top.__PVT__cfg_device_addr_base
        [4U];
    vlSymsp->TOP__test_top.__Vcellinp__u_bus__cfg_device_addr_base[0U] 
        = vlSymsp->TOP__test_top.__PVT__cfg_device_addr_base
    ...
    vlSymsp->TOP__test_top.__Vcellinp__u_bus__cfg_device_addr_mask[3U] 
        = vlSymsp->TOP__test_top.__PVT__cfg_device_addr_mask
        [3U];
    vlSymsp->TOP__test_top.__Vcellinp__u_bus__cfg_device_addr_mask[4U] 
        = vlSymsp->TOP__test_top.__PVT__cfg_device_addr_mask
        [4U];
    vlSymsp->TOP__test_top.__Vcellinp__u_bus__cfg_device_addr_mask[0U] 
        = vlSymsp->TOP__test_top.__PVT__cfg_device_addr_mask
...
void Vtest_top_test_top::_ctor_var_reset() {
    ...
    __PVT__uart0_tx_o = VL_RAND_RESET_I(1);
    __PVT__uart0_irq_o = VL_RAND_RESET_I(1);
    __Vcellout__uart0__data_o = VL_RAND_RESET_I(32);
    __PVT__uart1_tx_o = VL_RAND_RESET_I(1);
    __PVT__uart1_irq_o = VL_RAND_RESET_I(1);
    __Vcellout__uart1__data_o = VL_RAND_RESET_I(32);
    __PVT__u_bus__DOT__host_sel_req = VL_RAND_RESET_I(1);
    __PVT__u_bus__DOT__device_sel_req = VL_RAND_RESET_I(3);
    __PVT__u_bus__DOT__device_sel_resp = VL_RAND_RESET_I(3);
    ...
    __PVT__uart0__DOT__uart_ctrl = VL_RAND_RESET_I(8);
    __PVT__uart0__DOT__uart_status = VL_RAND_RESET_I(8);
    __PVT__uart0__DOT__tx_buffer = VL_RAND_RESET_I(8);
    __PVT__uart0__DOT__rx_buffer = VL_RAND_RESET_I(8);
    __PVT__uart0__DOT__baud_cnt = VL_RAND_RESET_I(10);
    __PVT__uart0__DOT__baud_tick = VL_RAND_RESET_I(1);
    __PVT__uart0__DOT__tx_state = VL_RAND_RESET_I(2);
    __PVT__uart0__DOT__tx_bit_cnt = VL_RAND_RESET_I(3);
    __PVT__uart0__DOT__tx_shift_reg = VL_RAND_RESET_I(8);
    __PVT__uart0__DOT__tx_busy = VL_RAND_RESET_I(1);
    __PVT__uart0__DOT__rx_state = VL_RAND_RESET_I(2);
    __PVT__uart0__DOT__rx_bit_cnt = VL_RAND_RESET_I(3);
    __PVT__uart0__DOT__rx_shift_reg = VL_RAND_RESET_I(8);
    __PVT__uart0__DOT__rx_done_flag = VL_RAND_RESET_I(1);
    __PVT__uart1__DOT__uart_ctrl = VL_RAND_RESET_I(8);
    __PVT__uart1__DOT__uart_status = VL_RAND_RESET_I(8);
    __PVT__uart1__DOT__tx_buffer = VL_RAND_RESET_I(8);
    __PVT__uart1__DOT__rx_buffer = VL_RAND_RESET_I(8);
    __PVT__uart1__DOT__baud_cnt = VL_RAND_RESET_I(10);
    __PVT__uart1__DOT__baud_tick = VL_RAND_RESET_I(1);
    __PVT__uart1__DOT__tx_state = VL_RAND_RESET_I(2);
    __PVT__uart1__DOT__tx_bit_cnt = VL_RAND_RESET_I(3);
    __PVT__uart1__DOT__tx_shift_reg = VL_RAND_RESET_I(8);
    __PVT__uart1__DOT__tx_busy = VL_RAND_RESET_I(1);
    __PVT__uart1__DOT__rx_state = VL_RAND_RESET_I(2);
    __PVT__uart1__DOT__rx_bit_cnt = VL_RAND_RESET_I(3);
    __PVT__uart1__DOT__rx_shift_reg = VL_RAND_RESET_I(8);
    __PVT__uart1__DOT__rx_done_flag = VL_RAND_RESET_I(1);
