...
void Vtest_top::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        {int i; for (i=0; i<1; i++) {
                tracep->declBit(c+244+i*1,"test_top host_req", true,(i+0));}}
        {int i; for (i=0; i<1; i++) {
                tracep->declBit(c+245+i*1,"test_top host_gnt", true,(i+0));}}
        {int i; for (i=0; i<1; i++) {
                tracep->declBus(c+246+i*1,"test_top host_addr", true,(i+0), 31,0);}}
        {int i; for (i=0; i<1; i++) {
                tracep->declBit(c+247+i*1,"test_top host_we", true,(i+0));}}
        {int i; for (i=0; i<1; i++) {
                tracep->declBus(c+248+i*1,"test_top host_wdata", true,(i+0), 31,0);}}
        {int i; for (i=0; i<1; i++) {
                tracep->declBus(c+249+i*1,"test_top host_rdata", true,(i+0), 31,0);}}
        {int i; for (i=0; i<3; i++) {
                tracep->declBit(c+250+i*1,"test_top device_req", true,(i+0));}}
        {int i; for (i=0; i<3; i++) {
                tracep->declBus(c+253+i*1,"test_top device_addr", true,(i+0), 31,0);}}
        {int i; for (i=0; i<3; i++) {
                tracep->declBit(c+256+i*1,"test_top device_we", true,(i+0));}}
        {int i; for (i=0; i<3; i++) {
                tracep->declBus(c+259+i*1,"test_top device_wdata", true,(i+0), 31,0);}}
        {int i; for (i=0; i<3; i++) {
                tracep->declBus(c+262+i*1,"test_top device_rdata", true,(i+0), 31,0);}}
        {int i; for (i=0; i<3; i++) {
        ...
        {int i; for (i=0; i<1; i++) {
                tracep->declBit(c+265+i*1,"test_top u_bus host_req_i", true,(i+0));}}
        {int i; for (i=0; i<1; i++) {
                tracep->declBit(c+266+i*1,"test_top u_bus host_gnt_o", true,(i+0));}}
        {int i; for (i=0; i<1; i++) {
                tracep->declBus(c+267+i*1,"test_top u_bus host_addr_i", true,(i+0), 31,0);}}
        {int i; for (i=0; i<1; i++) {
                tracep->declBit(c+268+i*1,"test_top u_bus host_we_i", true,(i+0));}}
        {int i; for (i=0; i<1; i++) {
                tracep->declBus(c+269+i*1,"test_top u_bus host_wdata_i", true,(i+0), 31,0);}}
        {int i; for (i=0; i<1; i++) {
                tracep->declBus(c+270+i*1,"test_top u_bus host_rdata_o", true,(i+0), 31,0);}}
        {int i; for (i=0; i<3; i++) {
                tracep->declBit(c+271+i*1,"test_top u_bus device_req_o", true,(i+0));}}
        {int i; for (i=0; i<3; i++) {
                tracep->declBus(c+274+i*1,"test_top u_bus device_addr_o", true,(i+0), 31,0);}}
        {int i; for (i=0; i<3; i++) {
                tracep->declBit(c+277+i*1,"test_top u_bus device_we_o", true,(i+0));}}
        {int i; for (i=0; i<3; i++) {
                tracep->declBus(c+280+i*1,"test_top u_bus device_wdata_o", true,(i+0), 31,0);}}
        {int i; for (i=0; i<3; i++) {
                tracep->declBus(c+283+i*1,"test_top u_bus device_rdata_i", true,(i+0), 31,0);}}
        {int i; for (i=0; i<3; i++) {
        ...
        tracep->declBus(c+286,"test_top u_bus host_sel_req", false,-1, 0,0);
        tracep->declBus(c+384,"test_top u_bus host_sel_resp", false,-1, 0,0);
        tracep->declBus(c+287,"test_top u_bus device_sel_req", false,-1, 1,0);
        tracep->declBus(c+288,"test_top u_bus device_sel_resp", false,-1, 1,0);
        ...
        tracep->declBit(c+380,"test_top clint0 clk_i", false,-1);
        tracep->declBit(c+381,"test_top clint0 rst_i", false,-1);
        tracep->declBit(c+289,"test_top clint0 req_i", false,-1);
        tracep->declBit(c+290,"test_top clint0 we_i", false,-1);
        tracep->declBus(c+291,"test_top clint0 addr_i", false,-1, 31,0);
        tracep->declBus(c+292,"test_top clint0 data_i", false,-1, 31,0);
        tracep->declBus(c+293,"test_top clint0 data_o", false,-1, 31,0);
        tracep->declBit(c+16,"test_top clint0 timer_irq_o", false,-1);
        tracep->declBit(c+15,"test_top clint0 software_irq_o", false,-1);
        tracep->declBus(c+401,"test_top clint0 MTIMECMP_BASE", false,-1, 15,0);
        tracep->declBus(c+402,"test_top clint0 MSIP_BASE", false,-1, 15,0);
        tracep->declBus(c+403,"test_top clint0 TIME_ADDR", false,-1, 15,0);
        tracep->declBus(c+294,"test_top clint0 raddr", false,-1, 15,0);
        {int i; for (i=0; i<2; i++) {
        ...
        tracep->declBit(c+295,"test_top clint0 is_time_addr0", false,-1);
        tracep->declBit(c+296,"test_top clint0 is_time_addr1", false,-1);
        tracep->declBit(c+297,"test_top clint0 is_mtimecmp_addr0", false,-1);
        tracep->declBit(c+298,"test_top clint0 is_mtimecmp_addr1", false,-1);
        tracep->declBit(c+299,"test_top clint0 is_msip_addr", false,-1);
        tracep->declQuad(c+31,"test_top clint0 time_interval", false,-1, 63,0);
        tracep->declBit(c+33,"test_top clint0 is_timeout", false,-1);
        tracep->declBit(c+34,"test_top clint0 is_mtimecmp_nonzero", false,-1);
        ...
        tracep->declBit(c+238,"test_top core_top0 exe_stallreq_o", false,-1);
        ...
        tracep->declBit(c+238,"test_top core_top0 ctrl0 stallreq_from_exe_i", false,-1);
        ...
        tracep->declBit(c+239,"test_top core_top0 pc_reg0 is_new_pc", false,-1);
        ...
        tracep->declBus(c+240,"test_top core_top0 id0 r_op1_o", false,-1, 31,0);
        tracep->declBus(c+241,"test_top core_top0 id0 r_op2_o", false,-1, 31,0);
        ...
        tracep->declBus(c+240,"test_top core_top0 id0 inst_type_r op1_o", false,-1, 31,0);
        tracep->declBus(c+241,"test_top core_top0 id0 inst_type_r op2_o", false,-1, 31,0);
        ...
        tracep->declBit(c+238,"test_top core_top0 exe0 stallreq_o", false,-1);
        ...
        tracep->declBit(c+238,"test_top core_top0 exe0 mult_div_stall", false,-1);
        ...
        tracep->declBit(c+238,"test_top core_top0 exe0 exe_type_m0 stall_o", false,-1);
        ...
        tracep->declBus(c+242,"test_top core_top0 exe0 exe_type_m0 mul0 S_nxt", false,-1, 2,0);
        ...
        tracep->declBus(c+243,"test_top core_top0 exe0 exe_type_m0 div0 S_next", false,-1, 2,0);
    ...
    // Body
    {
        ...
        tracep->fullBit(oldp+33,((1U & (~ (IData)((
                                                   ((((QData)((IData)(
                                                    ...
                                                    - vlSymsp->TOP__test_top.__PVT__clint0__DOT__mtimecmp) 
                                                   >> 0x3fU))))));
        tracep->fullBit(oldp+34,((0ULL == vlSymsp->TOP__test_top.__PVT__clint0__DOT__mtimecmp)));
        ...
        tracep->fullBit(oldp+238,((((IData)(vlSymsp->TOP__test_top__core_top0.__PVT__exe0__DOT__exe_type_m0__DOT__mult_req_o) 
        ...
        tracep->fullBit(oldp+239,(((IData)(vlSymsp->TOP__test_top__core_top0.__PVT__int_ctrl_interrupt_en_o) 
                                   | (IData)(vlSymsp->TOP__test_top__core_top0.__PVT__exe_jump_enable_o))));
        tracep->fullIData(oldp+240,((((IData)(vlSymsp->TOP__test_top__core_top0.__PVT__id0__DOT__inst_type_r__DOT__isType_r) 
                                      | (IData)(vlSymsp->TOP__test_top__core_top0.__PVT__id0__DOT__inst_type_r__DOT__isType_m))
        ...
        tracep->fullIData(oldp+241,((((IData)(vlSymsp->TOP__test_top__core_top0.__PVT__id0__DOT__inst_type_r__DOT__isType_r) 
                                      ...
                                      : 0U)),32);
        tracep->fullCData(oldp+242,(((0U == (IData)(vlSymsp->TOP__test_top__core_top0.__PVT__exe0__DOT__exe_type_m0__DOT__mul0__DOT__S))
                                      ? ((1U & ((~ (IData)(
                                                           (0U 
                                      ...
                                      : ((1U == (IData)(vlSymsp->TOP__test_top__core_top0.__PVT__exe0__DOT__exe_type_m0__DOT__mul0__DOT__S))
                                          ? ((0U != (IData)(vlSymsp->TOP__test_top__core_top0.__PVT__exe0__DOT__exe_type_m0__DOT__mul0__DOT__cnt))
                                              ? 1U : 3U)
                                          : 0U))),3);
        tracep->fullCData(oldp+243,(((0U == (IData)(vlSymsp->TOP__test_top__core_top0.__PVT__exe0__DOT__exe_type_m0__DOT__div0__DOT__S))
                                      ? ((IData)(vlSymsp->TOP__test_top__core_top0.__PVT__exe0__DOT__exe_type_m0__DOT__div_req_o)
                                          ...
                                          : 0U) : (
                                                   ...
                                                   ((0U 
                                                     ...
                                                     : 3U)
                                                    : 0U))),3);
        tracep->fullBit(oldp+244,(vlSymsp->TOP__test_top.__PVT__host_req[0]));
        tracep->fullBit(oldp+245,(vlSymsp->TOP__test_top.__PVT__host_gnt[0]));
        tracep->fullIData(oldp+246,(vlSymsp->TOP__test_top.__PVT__host_addr[0]),32);
        tracep->fullBit(oldp+247,(vlSymsp->TOP__test_top.__PVT__host_we[0]));
        tracep->fullIData(oldp+248,(vlSymsp->TOP__test_top.__PVT__host_wdata[0]),32);
        tracep->fullIData(oldp+249,(vlSymsp->TOP__test_top.__PVT__host_rdata[0]),32);
        tracep->fullBit(oldp+250,(vlSymsp->TOP__test_top.__PVT__device_req[0]));
        tracep->fullBit(oldp+251,(vlSymsp->TOP__test_top.__PVT__device_req[1]));
        tracep->fullBit(oldp+252,(vlSymsp->TOP__test_top.__PVT__device_req[2]));
        tracep->fullIData(oldp+253,(vlSymsp->TOP__test_top.__PVT__device_addr[0]),32);
        tracep->fullIData(oldp+254,(vlSymsp->TOP__test_top.__PVT__device_addr[1]),32);
        tracep->fullIData(oldp+255,(vlSymsp->TOP__test_top.__PVT__device_addr[2]),32);
        tracep->fullBit(oldp+256,(vlSymsp->TOP__test_top.__PVT__device_we[0]));
        tracep->fullBit(oldp+257,(vlSymsp->TOP__test_top.__PVT__device_we[1]));
        tracep->fullBit(oldp+258,(vlSymsp->TOP__test_top.__PVT__device_we[2]));
        tracep->fullIData(oldp+259,(vlSymsp->TOP__test_top.__PVT__device_wdata[0]),32);
        tracep->fullIData(oldp+260,(vlSymsp->TOP__test_top.__PVT__device_wdata[1]),32);
        tracep->fullIData(oldp+261,(vlSymsp->TOP__test_top.__PVT__device_wdata[2]),32);
        tracep->fullIData(oldp+262,(vlSymsp->TOP__test_top.__PVT__device_rdata[0]),32);
        tracep->fullIData(oldp+263,(vlSymsp->TOP__test_top.__PVT__device_rdata[1]),32);
        tracep->fullIData(oldp+264,(vlSymsp->TOP__test_top.__PVT__device_rdata[2]),32);
        tracep->fullBit(oldp+265,(vlSymsp->TOP__test_top.__Vcellinp__u_bus__host_req_i[0]));
        tracep->fullBit(oldp+266,(vlSymsp->TOP__test_top.__Vcellout__u_bus__host_gnt_o[0]));
        tracep->fullIData(oldp+267,(vlSymsp->TOP__test_top.__Vcellinp__u_bus__host_addr_i[0]),32);
        tracep->fullBit(oldp+268,(vlSymsp->TOP__test_top.__Vcellinp__u_bus__host_we_i[0]));
        tracep->fullIData(oldp+269,(vlSymsp->TOP__test_top.__Vcellinp__u_bus__host_wdata_i[0]),32);
        tracep->fullIData(oldp+270,(vlSymsp->TOP__test_top.__Vcellout__u_bus__host_rdata_o[0]),32);
        tracep->fullBit(oldp+271,(vlSymsp->TOP__test_top.__Vcellout__u_bus__device_req_o[0]));
        tracep->fullBit(oldp+272,(vlSymsp->TOP__test_top.__Vcellout__u_bus__device_req_o[1]));
        tracep->fullBit(oldp+273,(vlSymsp->TOP__test_top.__Vcellout__u_bus__device_req_o[2]));
        tracep->fullIData(oldp+274,(vlSymsp->TOP__test_top.__Vcellout__u_bus__device_addr_o[0]),32);
        tracep->fullIData(oldp+275,(vlSymsp->TOP__test_top.__Vcellout__u_bus__device_addr_o[1]),32);
        tracep->fullIData(oldp+276,(vlSymsp->TOP__test_top.__Vcellout__u_bus__device_addr_o[2]),32);
        tracep->fullBit(oldp+277,(vlSymsp->TOP__test_top.__Vcellout__u_bus__device_we_o[0]));
        tracep->fullBit(oldp+278,(vlSymsp->TOP__test_top.__Vcellout__u_bus__device_we_o[1]));
        tracep->fullBit(oldp+279,(vlSymsp->TOP__test_top.__Vcellout__u_bus__device_we_o[2]));
        tracep->fullIData(oldp+280,(vlSymsp->TOP__test_top.__Vcellout__u_bus__device_wdata_o[0]),32);
        tracep->fullIData(oldp+281,(vlSymsp->TOP__test_top.__Vcellout__u_bus__device_wdata_o[1]),32);
        tracep->fullIData(oldp+282,(vlSymsp->TOP__test_top.__Vcellout__u_bus__device_wdata_o[2]),32);
        tracep->fullIData(oldp+283,(vlSymsp->TOP__test_top.__Vcellinp__u_bus__device_rdata_i[0]),32);
        tracep->fullIData(oldp+284,(vlSymsp->TOP__test_top.__Vcellinp__u_bus__device_rdata_i[1]),32);
        tracep->fullIData(oldp+285,(vlSymsp->TOP__test_top.__Vcellinp__u_bus__device_rdata_i[2]),32);
        tracep->fullBit(oldp+286,(vlSymsp->TOP__test_top.__PVT__u_bus__DOT__host_sel_req));
        tracep->fullCData(oldp+287,(vlSymsp->TOP__test_top.__PVT__u_bus__DOT__device_sel_req),2);
        tracep->fullCData(oldp+288,(vlSymsp->TOP__test_top.__PVT__u_bus__DOT__device_sel_resp),2);
        tracep->fullBit(oldp+289,(vlSymsp->TOP__test_top.__PVT__device_req
                                  [0U]));
        tracep->fullBit(oldp+290,(vlSymsp->TOP__test_top.__PVT__device_we
                                  [0U]));
        tracep->fullIData(oldp+291,(vlSymsp->TOP__test_top.__PVT__device_addr
                                    [0U]),32);
        tracep->fullIData(oldp+292,(vlSymsp->TOP__test_top.__PVT__device_wdata
                                    [0U]),32);
        tracep->fullIData(oldp+293,(vlSymsp->TOP__test_top.__Vcellout__clint0__data_o),32);
